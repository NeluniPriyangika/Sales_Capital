...
const FlystudioHomepage = () => {
  ...
  const Logo = () => (
    <div className="h-8 md:h-10 lg:h-12 w-auto bg-gradient-to-r from-blue-500 to-purple-600 text-white font-bold flex items-center justify-center rounded px-4 text-sm md:text-base">
      FLYSTUDIO
    </div>
  );
      ...
      <div className="min-h-screen w-full bg-black flex flex-col">
        ...
        <div className="flex justify-between items-center p-4 bg-gradient-to-r from-gray-900 to-black">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {isNavDropdownOpen && (
              <div className="absolute right-0 top-full mt-2 w-48 bg-gray-900/95 backdrop-blur-sm rounded-lg shadow-xl border border-gray-700 z-50">
          ...
          {tabs.map((tab, index) => (
            <video
              ...
              className={`absolute inset-0 w-full h-full object-cover transition-all duration-800 ${
                index === activeTab ? 'opacity-100 scale-100' : 'opacity-0 scale-110'
              }`}
              autoPlay
              muted
              loop
        ...
        <div className="flex-1 bg-gradient-to-br from-gray-900 via-black to-gray-800 p-4 sm:p-6">
          ...
          <button 
            ...
            className="w-full px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-full hover:shadow-lg transition-all duration-300 relative overflow-hidden group"
          >
          ...
          <div className="flex overflow-x-auto space-x-3 sm:space-x-4 pb-2">
            {tabs.map((tab, index) => (
              <button
                ...
                className={`flex-shrink-0 px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium whitespace-nowrap rounded-full transition-all duration-300 relative overflow-hidden ${
                  index === activeTab 
              ...
              >
                {index === activeTab && (
                  <div className="absolute inset-0 rounded-full bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 opacity-75 animate-pulse"></div>
                )}
    ...
    <div className="h-screen w-full flex overflow-hidden bg-black" onWheel={handleWheel}>
      ...
      <div className="w-1/3 xl:w-1/4 bg-gradient-to-br from-gray-900 via-black to-gray-800 flex flex-col justify-center items-start px-6 lg:px-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <button 
            onClick={handleGetStarted}
            className="px-6 md:px-8 py-3 md:py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-full hover:shadow-2xl transition-all duration-300 transform hover:scale-105 relative overflow-hidden group"
          >
            <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-blue-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-full"></div>
            <span className="relative z-10">Get Started</span>
          </button>
        </div>
            ...
            {tabs.map((tab, index) => {
              ...
              return (
                <button
                  ...
                  className={`absolute px-6 md:px-8 py-3 md:py-4 text-sm md:text-lg font-semibold transition-all duration-800 group backdrop-blur-sm rounded-lg text-white bg-white/20 relative overflow-hidden ${
                ...
                >
                  ...
                  <div className={`absolute inset-0 rounded-lg transition-all duration-800 ${
                    isActive 
                      ? 'bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 animate-pulse p-0.5' 
                      : 'bg-white/30 p-0.5'
                  }`}>
                    <div className="w-full h-full bg-white/20 backdrop-blur-sm rounded-lg"></div>
                  </div>
